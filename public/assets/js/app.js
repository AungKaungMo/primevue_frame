!(function (n) {
   ...
   n("#side-menu").metisMenu(),
      ...
      //             : document.body.setAttribute("data-sidebar-size", "sm"));
      // }),
      n(document).on("click", ".vertical-menu-btn", function (t) {
         t.preventDefault(),
            n("body").toggleClass("sidebar-enable"),
            992 <= n(window).width() &&
               (null == a
      ...
      n(document).on("click", '[data-bs-toggle="fullscreen"]', function (t) {
         t.preventDefault(),
      ...
      n(document).on("click", ".right-bar-toggle", function (t) {
