         ...
         <div class="d-flex">
            ...
            <div class="navbar-brand-box">
               <a href="javascript: void(0);" class="logo logo-dark">
                  <span class="logo-sm">
                     <img src="@/assets/images/panda.png" alt="" height="22">
                  </span>
                  <span class="logo-lg">
                     <img src="@/assets/images/panda.png" alt="" height="20">
                  </span>
               </a>
         ...
         <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
               <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                  ...
                  <img class="rounded-circle header-profile-user" src="@/assets/images/panda.png" alt="Header Avatar">
                  <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-13">
                     {{ authStore.getName }}
                  </span>
